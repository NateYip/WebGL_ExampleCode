...
function main() {
  ...
  const tick = function() {
    ...
    draw(gl, n, currentAngle , modelMatrix , u_ModelMatrix ,viewMatrix ,u_ViewMatrix);
...
function draw(gl , n ,currentAngle ,modelMatrix , u_ModelMatrix ,viewMatrix ,u_ViewMatrix){
